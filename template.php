...
require_once dirname(__FILE__) . '/inc/misc_preprocess.inc';
require_once dirname(__FILE__) . '/inc/misc_process.inc';
require_once dirname(__FILE__) . '/inc/misc_theme_functions.inc';
